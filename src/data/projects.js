export const allProjects = [
  {
    ...
    longDescription: 'A comprehensive fintech platform with trading, staking, referral system, KYC verification, and a full admin dashboard. Built with security and scalability in mind for real-world financial operations.',
    ...
    features: [
      'Trading engine with real-time price feeds',
